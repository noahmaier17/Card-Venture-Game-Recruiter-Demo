...
class trampledRedent(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.R()], 'nil'))
...
class recycledShirt(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        ...
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.Gnotick()], cll.Attackcons([1, cll.Bnotick()], 'nil')))
...
class redCardboardBox(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.R()], 'nil'))
        ...
        if containsDrawInitialization:
            ...
            if len(otherCards) != 0:
                ...
                for card  in otherCards:
                    ...
                    + card.prettyCardText(41, 100, suppressedTypes = []))
                    index += 1
...
class bluePipe(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.B()], 'nil'))
...
class smellOfTheWild(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.G()], 'nil'))
...
class redBrush(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([3, cll.R()], 'nil'))
        self.lingering = 1
...
class whiteVase(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.M()], 'nil'))
'''
...
class greenBrush(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([3, cll.G()], 'nil'))
        self.lingering = 1
...
class blueBrush(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([3, cll.B()], 'nil'))
        self.lingering = 1
...
class redAndGreenPen(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.R()], cll.Attackcons([1, cll.G()], 'nil')))
...
class greenAndBluePen(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.G()], cll.Attackcons([1, cll.B()], 'nil')))
...
class blueAndRedPen(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.B()], cll.Attackcons([1, cll.R()], 'nil')))
...
class chewedRedPen(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        caster.plusActions(1)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.Rnotick()], 'nil'))
...
class chewedGreenPen(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        caster.plusActions(1)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.Gnotick()], 'nil'))
...
class chewedBluePen(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        caster.plusActions(1)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.Bnotick()], 'nil'))
...
class reallyChewedGraphium(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.Random()], 
                cll.Attackcons([1, cll.Random()], 'nil')))
...
class aridBrush(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        caster.plusActions(1)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.RandomNotick()], 
                                        cll.Attackcons([1, cll.RandomNotick()], 'nil')))
...
class yellowBoot(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([4, cll.L()], 'nil'))
...
class tarnishedScythe(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.Random()], 
                cll.Attackcons([2, cll.Random()], 'nil')))
        self.lingering = 1
...
class peelingRodent(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        caster.plusActions(1)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.Random()], cll.Attackcons([1, cll.Random()], 'nil')))
...
class brassMuzzle(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        # caster.plusActions(1)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.B()], cll.Attackcons([1, cll.M()], 'nil')))
        caster.plusUpcomingPlusCard(0, -1)
...
class blueCableCord(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        caster.plusActions(1)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.B()], 'nil'))
...
class heavyScrapMetal(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        caster.plusActions(1)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.M()], cll.Attackcons([1, cll.M()], 'nil')))
...
class bloodyRodentHead(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.R()], 
...
class bloodyRodentLegs(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.R()], cll.Attackcons([3, cll.Random()], 'nil')))
'''
...
class deepClayReservoir(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        ...
        if index != -1:
            ...
            enemies[index].damage(caster, dino, enemies, cll.Attackcons([1, cll.R()], 'nil'))
        caster.plusUpcomingPlusCard(0, -1)
'''
...
class deepClayReservoir(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        ...
        size = len(enemies[index].hand)
        for i in range(size):
            enemies[index].dealDamage(caster, dino, enemies, cll.Attackcons([1, cll.Rnotick()], 'nil'))
...
class scaryBeesNest(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([3, cll.L()], 'nil'))
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([3, cll.L()], 'nil'))
        self.lingering = 1
...
class stickProddingMantra(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        ...
        for i in range(3):
            caster.drawCard()
        for enemy in enemies:
            enemy.heal(caster, dino, enemies, cll.Attackcons([1, cll.M()], 'nil'))
...
class crushingBearHug(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        ...
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.R()], 
            cll.Attackcons([2, cll.G()], 
                cll.Attackcons([2, cll.B()], 'nil'))))
'''
...
class bearPaw(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.M()], 'nil'))
        caster.drawCard(printCard = True)
...
class barringGapsBetweenTeeth(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        ...
        index = h.pickLivingEnemy("Pick Enemy", enemies)
        if index != -1:
            enemies[index].damage(caster, dino, enemies, cll.Attackcons([9, cll.G()], 'nil'))
            enemies[index].heal(caster, dino, enemies, cll.Attackcons([1, cll.M()], 'nil'))
...
class tiltLeftAndConsume(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([3, cll.G()], cll.Attackcons([3, cll.R()], 'nil')))
'''
...
class tiltRightAndConsume(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([3, cll.B()], cll.Attackcons([3, cll.B()], 'nil')))
...
class bigBackScratcherTree(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        caster.plusActions(1)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([9, cll.L()], 'nil'))
...
class rightToBearArms(DinoCard):
    ...
    def onPlay(self, caster, dino, enemies, passedInVisuals):
        super().onPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.Random()], 'nil'))
        for i in range(2):
...
class rustedScythe(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.R()], cll.Attackcons([1, cll.M()], 'nil')))
...
class brassMuzzle(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        ...
        if index != -1:
            enemies[index].damage(caster, dino, enemies, cll.Attackcons([2, cll.B()], cll.Attackcons([1, cll.M()], 'nil')))
...
class gnawedCableCord(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        caster.plusActions(1)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.Bnotick()], 'nil'))
        index = h.locateCardIndex(caster.play, self)
        if index >= 0:
            caster.moveCard(caster.play, index, caster.draw, position = 0)
        else:
...
class trampledRodent(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.Rnotick()],
...
class mangledShrew(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.Rnotick()],
                                                             cll.Attackcons([1, cll.Random()],
                                                             cll.Attackcons([1, cll.Random()],
                                                             cll.Attackcons([1, cll.Random()],
                                                             'nil')))))
...
class lastSeeds(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        caster.plusActions(1)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.L()], cll.Attackcons([1, cll.M()], 'nil')))
...
class coercionCultivator(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        ...
        if index != -1:
            ...
            enemy.damage(caster, dino, enemies, cll.Attackcons([6, cll.Random()], 'nil'))
            if enemy.dead == False:
...
class grayHubcap(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        caster.plusActions(1)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.G()], 'nil'))
...
class metalTrashBins(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.M()], cll.Attackcons([1, cll.M()], cll.Attackcons([1, cll.M()], 'nil'))))
...
class wheelShrapnel(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        caster.plusActions(1)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.R()], cll.Attackcons([2, cll.M()], 'nil')))
        while caster.hand.length() > 0:
            caster.discardCard(caster.hand, 0)
...
class carFeigning(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.G()], cll.Attackcons([1, cll.R()], 'nil')))
...
class treeClimbers(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        caster.drawCard(printCard = True)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([3, cll.G()], cll.Attackcons([2, cll.G()], 'nil')))
...
class recyclingBin(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([3, cll.B()], cll.Attackcons([2, cll.G()], 'nil')))
        while caster.hand.length() > 0:
            caster.discardCard(caster.hand, 0)
...
class boneGnaw(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        caster.drawCard(printCard = True)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([1, cll.M()], cll.Attackcons([1, cll.M()], cll.Attackcons([1, cll.M()], cll.Attackcons([1, cll.M()], 'nil')))))
        caster.damage(caster, dino, enemies, cll.Attackcons([1, cll.M()], 'nil'))
...
class shoulderHump(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([4, cll.Random()], cll.Attackcons([3, cll.Random()], 'nil')))
...
class bearClaws(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([3, cll.R()], cll.Attackcons([3, cll.B()], 'nil')))
...
class backScratcher(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        ...
        caster.plusActions(1)
        caster.drawCard()
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([10, cll.L()], 'nil'))
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        ...
        for i in range(3):
            ...
            if len(livingEnemies) > 0:
                ...
                enemy.damage(caster, dino, enemies, cll.Attackcons([3, cll.L()], 'nil'))
            else:
...
class metalCrate(DinoCard):
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        super().duringPlay(caster, dino, enemies, passedInVisuals)
        self.foreverLinger = True
        c.dealDamage(caster, dino, enemies, passedInVisuals, cll.Attackcons([2, cll.M()], cll.Attackcons([2, cll.M()], 'nil')))
    ...
    def duringPlay(self, caster, dino, enemies, passedInVisuals):
        ...
        for enemy in enemies:
            if enemy.dead == False:
                ...
                enemy.damage(caster, dino, enemies, cll.Attackcons([1, cll.L()], 'nil'))
